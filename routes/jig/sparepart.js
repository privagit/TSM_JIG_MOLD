...
router.post('/spare-part', async (req, res) => { //TODO: StoreProcedure, SupplierID
    try {
        let pool = await sql.connect(config);
...
router.post('/spare-part/restock', async (req, res) => { //TODO: SupplierID
    try {
        let pool = await sql.connect(config);
...
router.post('/spare-part/restorck/item', async (req, res) => { //TODO: SupplierID
    try {
        let pool = await sql.connect(config);
        ...
        a.PrNo, a.PoNo, a.InvoiceNo, a.Qty, a.Price, a.Amount, b.FirstName AS ReceiveName
        FROM [Jig].[SpareRestock] a
